...
public class TestRandomFlooder {
	...
	public static void main( String[] args ) throws FlooderException {
		...
		UUID id1 = daemon.randomFlooder().flood( Path.of( "C:\\Users\\thanh\\Desktop\\ranflood_testsite\\attackedFolder\\folder1" ) );
		try {
			Thread.sleep( 2000 );
		} catch ( InterruptedException e ) {
			e.printStackTrace();
		}
		UUID id2 = daemon.randomFlooder().flood( Path.of( "C:\\Users\\thanh\\Desktop\\ranflood_testsite\\attackedFolder\\folder2" ) );
		try {
			Thread.sleep( 2000 );
		} catch ( InterruptedException e ) {
			e.printStackTrace();
