...
//		System.out.println( Arrays.toString( signature ) );
		...
		FileOutputStream outputStream = new FileOutputStream( "/home/trthanh/Desktop/Ranflood/test." + extension );
		outputStream.write( b.array() );
		outputStream.close();
		Runtime rt = Runtime.getRuntime();
		Process pr = rt.exec("file /home/trthanh/Desktop/Ranflood/test." + extension );
		pr.waitFor();
		new BufferedReader( new InputStreamReader( pr.getInputStream() ) ).lines().forEach( System.out::println );
		new File( "/home/trthanh/Desktop/Ranflood/test." + extension ).delete();
	}
}